"""Mint Scan v7 — Shared Widgets (NO alpha hex colors)"""
    ...
    def __init__(self, parent, items, columns=2, **kwargs):
        ...
        for i, item in enumerate(items):
            ...
            ctk.CTkLabel(cell, text=value, font=MONO_SM,
                         text_color=color, wraplength=200).pack(
...
class ResultBox(ctk.CTkFrame):
    def __init__(self, parent, rtype='ok', title='', body='', **kwargs):
        ...
        super().__init__(parent, fg_color=C['s2'],
        ...
        if body:
            ctk.CTkLabel(self, text=body, font=MONO_SM,
                         text_color=C['mu'], wraplength=640,
...
class Badge(ctk.CTkFrame):
    def __init__(self, parent, label, color, **kwargs):
        ...
        ctk.CTkLabel(self, text=label, font=('Courier',7,'bold'),
...
class PortBar(ctk.CTkFrame):
    def __init__(self, parent, port, proto, state, process, **kwargs):
        ...
        SVCS = {'20':'FTP-Data','21':'FTP','22':'SSH','23':'Telnet',
                '25':'SMTP','53':'DNS','80':'HTTP','443':'HTTPS',
                '3306':'MySQL','5432':'PostgreSQL','6379':'Redis',
                '8080':'HTTP-Alt','27017':'MongoDB','4444':'Metasploit⚠','1337':'Suspicious⚠'}
